...
const ACTIONS: Partial<Record<DatabaseResource, readonly string[]>> = {
  ...
  treasure_addresses: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_brands: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_categories: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_inventory: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_order_items: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_orders: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_payments: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_product_collections: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_product_variants: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_products: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_reviews: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_subcategories: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_subscriptions: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
  treasure_warehouses: [...DEFAULT_RESOURCE_ACTIONS, "restore", "permanentDelete"],
...
const RESOURCE_TABLES = {
  ...
  session,
  treasure_addresses: addresses,
  treasure_brands: brands,
  treasure_categories: categories,
  treasure_inventory: inventory,
  treasure_order_items: orderItems,
  treasure_orders: orders,
  treasure_payments: payments,
  treasure_product_collections: productCollections,
  treasure_product_variants: productVariants,
  treasure_products: products,
  treasure_reviews: reviews,
  treasure_subcategories: subcategories,
  treasure_subscriptions: subscriptions,
  treasure_warehouses: warehouses,
  user,
