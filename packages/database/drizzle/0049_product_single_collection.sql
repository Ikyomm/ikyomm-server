...
ALTER TABLE "treasure_products" ADD CONSTRAINT "treasure_products_collection_id_treasure_product_collections_id_fk" FOREIGN KEY ("collection_id") REFERENCES "public"."treasure_product_collections"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
CREATE INDEX "treasure_products_collection_id_idx" ON "treasure_products" USING btree ("collection_id");--> statement-breakpoint
DROP TABLE "treasure_product_collection_products";--> statement-breakpoint
