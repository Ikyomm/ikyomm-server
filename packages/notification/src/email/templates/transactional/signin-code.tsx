...
const defaultData = {
  otpCode: "572100",
  previewText: "Your Ikyomm sign-in verification code",
  codeExpiryTime: "10",
};
          ...
          <Container className="mx-auto max-w-[580px] px-4 pt-10 pb-6">
            <Section>
              <Section className="bg-bg border-stroke border">
                <EmailHeader panel={panel} />
                <Section className="mobile:px-6! px-8 pt-8 pb-10">
                  <Text className="font-32 text-fg m-0 font-sans">Sign In to {brand.name}</Text>
                  ...
                  <Text className="font-14 font-inter text-fg-2 m-0 mt-2">
                    Enter the code above on your device to sign in to {brand.name}. This code will
