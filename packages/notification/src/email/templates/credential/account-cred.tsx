...
const defaultData = {
  previewText: "Your Ommpods Account is Ready!",
            ...
            <Section>
              <Section className="bg-bg border-stroke border">
                ...
                <Section className="mobile:px-6! px-8 pt-8 pb-10">
                  <Text className="font-32 text-fg m-0 font-sans">Ommpods Account Activated</Text>
                  ...
                  <Text className="font-14 font-inter text-fg-2 m-0 mt-[10px]">
                    ...
                    successfully activated to Ommpods.
                  </Text>
                  <Text className="font-14 font-inter text-fg-2 m-0 mt-[10px]">
