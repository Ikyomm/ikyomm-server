...
const defaultData = {
  previewText: "You're invited to join Ommpods!",
  credEmail: "mondalsuman97322@gmail.com",
  credPassword: "password123",
  role: "Admin",
};

type OmmpodsAccountCredEmailProps = {
  previewText: string;
  credEmail?: string;
  credPassword?: string;
  role?: string;
...
export const OmmpodsAccountCredEmail = ({
  previewText,
  credEmail = "",
  credPassword = "",
  role,
}: OmmpodsAccountCredEmailProps) => {
              ...
              <Section className="bg-bg border-stroke border">
                ...
                <Section className="mobile:px-6! px-8 pt-8 pb-10">
                  ...
                  <Text className="font-14 font-inter text-fg-2 m-0 mt-[10px]">
                    Your Ommpods account has been successfully set up as a{" "}
...
OmmpodsAccountCredEmail.PreviewProps = defaultData;

export default OmmpodsAccountCredEmail;

export const renderOmmpodsAccountCredEmail = async (props: OmmpodsAccountCredEmailProps) =>
  pretty(await render(<OmmpodsAccountCredEmail {...props} />));
